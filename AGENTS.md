...
in thousands of repos — a deliberate design-class choice, not measured adoption
(see `docs/audit-infrastructure-class.md`) — the security bar is maximal — supply-chain and mass-RCE
