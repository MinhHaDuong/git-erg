...
TEST_SUITES := validate check list ready update close migrate nextid log label new init main archive rm datasafety security pipeline help version hook godoc docs contract roundtrip verify
